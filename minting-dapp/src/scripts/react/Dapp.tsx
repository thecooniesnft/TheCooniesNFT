...
const ContractAbi = require('../../../../smart-contract/artifactsx/contracts/' + CollectionConfig.contractName + '.sol/' + CollectionConfig.contractName + '.json').abi;
      ...
      <>
              ...
              <>
                ...
                {!this.isSoldOut() ?
                  ...
                  <div className="collection-sold-out">
                    <h2>TheCoonies NFT Tokens have been <strong>sold out</strong>! <span className="emoji">❤️</span></h2>
        ...
        :
          <div className="no-wallet">
            {!this.isWalletConnected() ? <button className="primary" disabled={this.provider === undefined} onClick={() => this.connectWallet()}>Connect Web3 Wallet</button> : null}
