...
interface TheCooniesNFTMaticInterface extends ethers.utils.Interface {
  functions: {
...
export class TheCooniesNFTMatic extends BaseContract {
  ...
  interface: TheCooniesNFTMaticInterface;
